var Datepicker = (function() {
  ...
  function r(e, t, i = {}, s = 0, a = "") {
    a += `<${Object.keys(i).reduce((e, t) => {
      let a = i[t];
      return "function" == typeof a && (a = a(s)), `${e} ${t}="${a}"`;
    }, e)}></${e}>`;
    const n = s + 1;
  ...
  const D = {
      ...
      m(e, t, i) {
        ...
        if (isNaN(a)) {
          ...
          if (
            (
              (a = i.monthsShort.findIndex(s)) < 0 &&
                (a = i.months.findIndex(s)),
              a < 0
            )
          )
            return NaN;
        }
        return s.setMonth(a), s.getMonth() !==
        (function e(t) {
  ...
  function x(e) {
    ...
    const a = s.map(e => v[e]),
      n = Object.keys(D).reduce((e, t) => {
        return s.find(e => "D" !== e[0] && e[0].toLowerCase() === t) &&
          e.push(t), e;
      }, []);
    return (k[e] = {
      parser(e, t) {
      ...
      formatter: (e, s) =>
        a.reduce((t, a, n) => t + `${i[n]}${a(e, s)}`, "") + t(i)
    });
  }
  function M(e, t, i) {
  ...
  const C = new WeakMap(),
    { addEventListener: O, removeEventListener: E } = EventTarget.prototype;
  function F(e, t) {
    let i = C.get(e);
  ...
  if (!Event.prototype.composedPath) {
    const e = (t, i = []) => {
      let s;
      return i.push(t), t.parentNode
        ? (s = t.parentNode)
        : t.host ? (s = t.host) : t.defaultView && (s = t.defaultView), s
        ? e(s, i)
        : i;
    };
  ...
  const { language: T, format: H, weekStart: $ } = L;
  function _(e, t) {
  ...
  function q(t, s) {
      ...
      if (
        (
          a.language !== o &&
            (r[a.language]
              ? (e = a.language)
              : void 0 === r[(e = a.language.split("-")[0])] && (e = !1)),
          delete a.language,
          e
        )
      ) {
        o = n.language = e;
        const t = c || r[T];
        (c = Object.assign({ format: H, weekStart: $ }, r[T])), o !== T &&
          Object.assign(c, r[o]), (n.locale = c), d === t.format &&
          (d = n.format = c.format), g === t.weekStart &&
          ((g = n.weekStart = c.weekStart), (n.weekEnd = j(c.weekStart)));
      }
    }
    if (a.format) {
    ...
    if (
      (
        void 0 !== a.minDate &&
          (
            (y = null === a.minDate ? l(0, 0, 1) : I(a.minDate, d, c, y)),
            delete a.minDate
          ),
        void 0 !== a.maxDate &&
          (
            (k = null === a.maxDate ? void 0 : I(a.maxDate, d, c, k)),
            delete a.maxDate
          ),
        k < y
          ? ((f = n.minDate = k), (h = n.maxDate = y))
          : (f !== y && (f = n.minDate = y), h !== k && (h = n.maxDate = k)),
        a.datesDisabled &&
          (
            (n.datesDisabled = a.datesDisabled.reduce((e, t) => {
              const s = M(t, d, c);
    ...
    if (void 0 !== a.weekStart) {
      ...
      isNaN(e) ||
        ((g = n.weekStart = e), (n.weekEnd = j(e))), delete a.weekStart;
    }
    if (
      (
        a.daysOfWeekDisabled &&
          (
            (n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce(_, [])),
            delete a.daysOfWeekDisabled
          ),
        a.daysOfWeekHighlighted &&
          (
            (n.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce(_, [])),
      ...
      e >= 0 &&
        (
          (n.maxNumberOfDates = e),
          (n.multidate = 1 !== e)
        ), delete a.maxNumberOfDates;
    }
    a.dateDelimiter &&
      ((n.dateDelimiter = String(a.dateDelimiter)), delete a.dateDelimiter);
    let D = p;
    void 0 !== a.pickLevel &&
      ((D = P(a.pickLevel, 2)), delete a.pickLevel), D !== p &&
      (p = n.pickLevel = D);
    let v = u;
    void 0 !== a.maxView && ((v = P(a.maxView, u)), delete a.maxView), (v =
      p > v ? p : v) !== u && (u = n.maxView = v);
    let b = m;
    if (
      (
        void 0 !== a.startView && ((b = P(a.startView, b)), delete a.startView),
        b < p ? (b = p) : b > u && (b = u),
        b !== m && (n.startView = b),
        a.prevArrow
      )
    ) {
      const e = A(a.prevArrow);
      e.childNodes.length > 0 &&
        (n.prevArrow = e.childNodes), delete a.prevArrow;
    }
    if (a.nextArrow) {
      const e = A(a.nextArrow);
      e.childNodes.length > 0 &&
        (n.nextArrow = e.childNodes), delete a.nextArrow;
    }
    if (
      (
  ...
  const J = d(
    ...
    R = d(
      `<div class="days">\n  <div class="days-of-week">${r("span", 7, {
        class: "dow"
  ...
  class z {
    ...
    init(e) {
      void 0 !== e.pickLevel &&
        (this.isMinView = this.id === e.pickLevel), this.setOptions(
        e
      ), this.updateFocus(), this.updateSelection();
    }
    performBeforeHook(e, t, s) {
      ...
      if (a) {
        ...
        a.content &&
          (function(e, t) {
            K(e), t instanceof DocumentFragment
              ? e.appendChild(t)
              : "string" == typeof t
                ? e.appendChild(A(t))
  ...
  class X extends z {
    ...
    init(e, t = !0) {
      if (t) {
        const e = A(R).firstChild;
        (this.dow = e.firstChild), (this.grid =
          e.lastChild), this.element.appendChild(e);
      }
      super.init(e);
    }
    setOptions(t) {
      ...
      if (
        ...
        (this.dayNames = e.daysMin), (this.switchLabelFormat =
          e.titleFormat), (i = !0);
      }
      if (
        (
      ...
      void 0 !== t.showDaysOfWeek &&
        (t.showDaysOfWeek
          ...
          : (
              Y(this.dow),
              this.calendarWeeks && Y(this.calendarWeeks.dow)
            )), i &&
        Array.from(this.dow.children).forEach((e, t) => {
          const i = (this.weekStart + t) % 7;
          (e.textContent = this.dayNames[
            i
    ...
    updateFocus() {
      ...
      (this.first = s), (this.last = l(
        t,
        i + 1,
        0
      )), (this.start = a), (this.focused = this.picker.viewDate);
    }
    updateSelection() {
    ...
    render() {
      (this.today = this.todayHighlight ? c() : void 0), (this.disabled = [
        ...this.datesDisabled
      ]);
      ...
      Array.from(this.grid.children).forEach((e, t) => {
        ...
        if (
          (
            ...
            a < this.first ? s.add("prev") : a > this.last && s.add("next"),
            this.today === a && s.add("today"),
            (a < this.minDate ||
              a > this.maxDate ||
              this.disabled.includes(a)) &&
              s.add("disabled"),
            this.daysOfWeekDisabled.includes(r) &&
              (s.add("disabled"), i(this.disabled, a)),
            this.daysOfWeekHighlighted.includes(r) && s.add("highlighted"),
            this.range
          )
        ) {
          const [e, t] = this.range;
          a > e && a < t && s.add("range"), a === e &&
            s.add("range-start"), a === t && s.add("range-end");
        }
        this.selected.includes(a) && s.add("selected"), a === this.focused &&
          s.add("focused"), this.beforeShow && this.performBeforeHook(e, a, a);
      });
    }
    refresh() {
      const [e, t] = this.range || [];
      this.grid
        ...
        const s = Number(i.dataset.date),
          a = i.classList;
        s > e && s < t && a.add("range"), s === e && a.add("range-start"), s ===
          t && a.add("range-end"), this.selected.includes(s) &&
          a.add("selected"), s === this.focused && a.add("focused");
      });
    }
    refreshFocus() {
  ...
  class Q extends z {
    ...
    init(e, t = !0) {
      t &&
        (
          ...
          this.grid.appendChild(A(r("span", 12, { "data-month": e => e })))
        ), super.init(e);
    }
    setOptions(t) {
      if (
        ...
        if (void 0 === t.minDate)
          ...
          (this.minYear = e.getFullYear()), (this.minMonth = e.getMonth()), (this.minDate = e.setDate(
            1
          ));
        }
      if (e(t, "maxDate"))
        if (void 0 === t.maxDate)
          ...
          (this.maxYear = e.getFullYear()), (this.maxMonth = e.getMonth()), (this.maxDate = l(
            this.maxYear,
            this.maxMonth + 1,
            0
          ));
    ...
    render() {
      (this.disabled = []), this.picker.setViewSwitchLabel(
        this.year
      ...
      Array.from(this.grid.children).forEach((n, r) => {
        ...
        if (
          (
            (n.className = `datepicker-cell ${this.cellClass}`),
            this.isMinView && (n.dataset.date = o),
            (n.textContent = this.monthNames[r]),
          ...
          const [e, t] = a;
          r > e && r < t && d.add("range"), r === e &&
            d.add("range-start"), r === t && d.add("range-end");
        }
        e.includes(r) && d.add("selected"), r === this.focused &&
          d.add("focused"), this.beforeShow && this.performBeforeHook(n, r, o);
      });
    }
    refresh() {
      const e = this.selected[this.year] || [],
        [t, i] = G(this.range, this.year) || [];
      this.grid
        .querySelectorAll(
          ".range, .range-start, .range-end, .selected, .focused"
        )
        ...
        const n = s.classList;
        a > t && a < i && n.add("range"), a === t && n.add("range-start"), a ===
          i && n.add("range-end"), e.includes(a) && n.add("selected"), a ===
          this.focused && n.add("focused");
      });
    }
    refreshFocus() {
      this.grid.querySelectorAll(".focused").forEach(e => {
  ...
  class Z extends z {
    ...
    init(e, t = !0) {
      ...
      t &&
        (
          ...
          this.grid.appendChild(A(r("span", 12)))
        ), super.init(e);
    }
    setOptions(t) {
      if (
        (
          e(t, "minDate") &&
            (void 0 === t.minDate
              ...
              : (
                  (this.minYear = g(t.minDate, this.step)),
          ...
          e(t, "maxDate") &&
            (void 0 === t.maxDate
              ...
              : (
                  (this.maxYear = g(t.maxDate, this.step)),
    ...
    updateFocus() {
      const e = new Date(this.picker.viewDate),
        t = g(e, this.navStep),
        i = t + 9 * this.step;
      (this.first = t), (this.last = i), (this.start =
        t - this.step), (this.focused = g(e, this.step));
    }
    updateSelection() {
      const { dates: e, rangepicker: t } = this.picker.datepicker;
      (this.selected = e.reduce((e, t) => i(e, g(t, this.step)), [])), t &&
        t.dates &&
        (this.range = t.dates.map(e => {
          if (void 0 !== e) return g(e, this.step);
        }));
    }
    render() {
      (this.disabled = []), this.picker.setViewSwitchLabel(
      ...
      ), this.picker.setNextBtnDisabled(this.last >= this.maxYear), Array.from(
        this.grid.children
      ).forEach((e, t) => {
        const i = e.classList,
        ...
        if (
          (
            ...
            (s < this.minYear || s > this.maxYear) && i.add("disabled"),
            this.range
          )
        ) {
          const [e, t] = this.range;
          s > e && s < t && i.add("range"), s === e &&
            i.add("range-start"), s === t && i.add("range-end");
        }
        this.selected.includes(s) && i.add("selected"), s === this.focused &&
          i.add("focused"), this.beforeShow && this.performBeforeHook(e, s, a);
      });
    }
    refresh() {
      const [e, t] = this.range || [];
  ...
  function te(e, t) {
    const { minDate: i, maxDate: s } = e.config,
      { currentView: a, viewDate: r } = e.picker;
    let d;
    switch (a.id) {
      case 0:
        d = u(r, t);
  ...
  function ne(t, i) {
    if (
      (
        void 0 !== i.title &&
          (i.title
            ? ((t.controls.title.textContent = i.title), W(t.controls.title))
            : ((t.controls.title.textContent = ""), Y(t.controls.title))),
        i.prevArrow
      )
    ) {
    ...
    if (
      (
        ...
        void 0 !== i.todayBtn &&
          (i.todayBtn ? W(t.controls.todayBtn) : Y(t.controls.todayBtn)),
    ...
    void 0 !== i.clearBtn &&
      (i.clearBtn ? W(t.controls.clearBtn) : Y(t.controls.clearBtn));
  }
  function re(e) {
  ...
  function de(e, t) {
    const i = new Date(e.viewDate),
      s = new Date(t),
      { id: a, year: n, first: r, last: d } = e.currentView,
      o = s.getFullYear();
    switch ((
      (e.viewDate = t),
      o !== i.getFullYear() && ee(e.datepicker, "changeYear"),
      s.getMonth() !== i.getMonth() && ee(e.datepicker, "changeMonth"),
      a
    )) {
      case 0:
        return t < r || t > d;
  ...
  class ce {
    constructor(e) {
      ...
      i.classList.add(`datepicker-${p}`), ne(
        this,
        e.config
      ), (this.viewDate = re(e)), F(e, [
        [
          i,
          "click",
          function(e) {
        ...
        [
          ...
          "click",
          function(e, t) {
            const i = V(t, ".datepicker-cell");
            if (!i || i.classList.contains("disabled")) return;
            const { id: s, isMinView: a } = e.picker.currentView;
            a
              ? e.setDate(Number(i.dataset.date))
              : ae(
                  e,
                  1 === s ? Number(i.dataset.month) : Number(i.dataset.year)
                );
          }.bind(null, e)
        ],
        [
        ...
        new X(this),
        new Q(this),
        new Z(this, { id: 2, name: "years", cellClass: "year", step: 1 }),
        new Z(this, { id: 3, name: "decades", cellClass: "decade", step: 10 })
      ]), (this.currentView = this.views[
        e.config.startView
      ]), this.currentView.render(), this.main.appendChild(
    ...
    show() {
      ...
      if (!e.inline) {
        const t = oe(e.inputField);
        t !== oe(e.config.container)
          ? (this.element.dir = t)
          : this.element.dir &&
            this.element.removeAttribute("dir"), this.place(), e.config
          .disableTouchKeyboard && e.inputField.blur();
      }
      ee(e, "show");
    }
    hide() {
      this.active &&
        (
          ...
          (this.active = !1),
          ee(this.datepicker, "hide")
        );
    }
    place() {
      const { classList: e, style: t } = this.element,
        { config: i, inputField: s } = this.datepicker,
        a = i.container,
        { width: n, height: r } = this.element.getBoundingClientRect(),
        { left: d, top: o, width: c } = a.getBoundingClientRect(),
        { left: l, top: h, width: u, height: f } = s.getBoundingClientRect();
      let p,
        m,
        g,
        { x: w, y: y } = i.orientation;
      a === document.body
        ? ((p = window.scrollY), (m = l + window.scrollX), (g = h + p))
        : ((m = l - d), (g = h - o + (p = a.scrollTop))), "auto" === w &&
        (m < 0
          ? ((w = "left"), (m = 10))
          : (w =
              m + n > c
                ? "right"
                : "rtl" === oe(s) ? "right" : "left")), "right" === w &&
        (m -= n - u), "auto" === y &&
        (y = g - r < p ? "bottom" : "top"), "top" === y
        ? (g -= r)
        : (g += f), e.remove(
      ...
      ), e.add(`datepicker-orient-${y}`, `datepicker-orient-${w}`), (t.top = g
        ? `${g}px`
        : g), (t.left = m ? `${m}px` : m);
    }
    ...
    changeView(e) {
      ...
      return i.id !== t.id &&
        (
          ...
          ee(this.datepicker, "changeView"),
          this.main.replaceChild(i.element, t.element)
        ), this;
    }
    changeFocus(e) {
      return (this._renderMethod = de(this, e)
        ? "render"
        : "refreshFocus"), this.views.forEach(e => {
        e.updateFocus();
      }), this;
    }
    update() {
      const e = re(this.datepicker);
      return (this._renderMethod = de(this, e)
        ? "render"
        : "refresh"), this.views.forEach(e => {
  ...
  function le(e, t, i, s) {
    ...
    switch (r.id) {
      case 0:
        (l = s
          ? h(l, 7 * i)
          : t.ctrlKey || t.metaKey ? f(l, i) : h(l, i)), (o = h), (c = e =>
          r.disabled.includes(e));
        break;
      case 1:
        ...
        break;
      default:
        (l = f(l, i * (s ? 4 : 1) * d)), (o = f), (c = e =>
          r.disabled.includes(g(e, d)));
    }
    void 0 !==
      (l = (function e(t, i, s, n, r, d) {
        if (a(t, r, d)) return n(t) ? e(i(t, s), i, s, n, r, d) : t;
      })(l, o, i < 0 ? -d : d, c, r.minDate, r.maxDate)) &&
      n.changeFocus(l).render();
  }
  function he(e, t) {
    return e.map(e => S(e, t.format, t.locale)).join(t.dateDelimiter);
  }
  function ue(e, t, i = !1) {
    const { config: s, dates: n, rangepicker: r } = e;
    ...
    let o = t.reduce((e, t) => {
      ...
      if (s.pickLevel > 0) {
        ...
        i =
          1 === s.pickLevel
            ? d ? e.setMonth(e.getMonth() + 1, 0) : e.setDate(1)
            : d ? e.setFullYear(e.getFullYear() + 1, 0, 0) : e.setMonth(0, 1);
      }
      return !a(i, s.minDate, s.maxDate) ||
        e.includes(i) ||
    ...
    return 0 !== o.length
      ? (
          ...
          s.maxNumberOfDates && o.length > s.maxNumberOfDates
            ? o.slice(-1 * s.maxNumberOfDates)
            : o
        )
      : void 0;
  }
  function fe(e, t = 3, i = !0) {
    const { config: s, picker: a, inputField: n } = e;
    if (2 & t) {
  ...
  function pe(e, t, i) {
    let { clear: s, render: a, autohide: n } = i;
    void 0 === a && (a = !0), a
      ? void 0 === n && (n = e.config.autohide)
      : (n = !1);
    const r = ue(e, t, s);
    r &&
      (
        r.toString() !== e.dates.toString()
          ? ((e.dates = r), fe(e, a ? 3 : 1), ee(e, "changeDate"))
          : fe(e, 1),
        n && e.hide()
      );
  }
  return class {
    constructor(e, t = {}, i) {
      ...
      let r, d;
      if (n)
        (a.container = e), (d = s(e.dataset.date, a.dateDelimiter)), delete e
          .dataset.date;
      else {
        const i = t.container ? document.querySelector(t.container) : null;
        i && (a.container = i), (r = this.inputField = e).classList.add(
          "datepicker-input"
        ), (d = s(r.value, a.dateDelimiter));
      }
      if (i) {
      ...
      const l = (this.picker = new ce(this));
      if (n) this.show();
      else {
        ...
        F(this, [
          [
            ...
            function(e, t) {
              ...
              const i = e.picker,
                { id: s, isMinView: a } = i.currentView;
              if (i.active)
                if (e.editMode)
                  switch (t.key) {
                    case "Escape":
    ...
    setOptions(e) {
      const t = this.picker,
        i = q(e, this);
      Object.assign(this._options, e), Object.assign(
        this.config,
        i
      ), t.setOptions(i), fe(this, 3);
    }
    show() {
      if (this.inputField) {
    ...
    destroy() {
      return this.hide(), (function(e) {
        ...
        this.inputField.classList.remove("datepicker-input"), delete this
    ...
    getDate(e) {
      ...
      return this.config.multidate
        ? this.dates.map(t)
        : this.dates.length > 0 ? t(this.dates[0]) : void 0;
    }
    setDate(...e) {
      const i = [...e],
        s = {},
      ...
      "object" != typeof a ||
        ...
        a instanceof Date ||
        !a ||
        Object.assign(s, i.pop()), pe(this, Array.isArray(i[0]) ? i[0] : i, s);
    }
    update(e) {
    ...
    refresh(e, t = !1) {
      let i;
      e && "string" != typeof e && ((t = e), (e = void 0)), fe(
        this,
