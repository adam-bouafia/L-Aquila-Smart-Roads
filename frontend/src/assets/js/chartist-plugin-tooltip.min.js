    ...
    (c.plugins = c.plugins || {}), (c.plugins.tooltip = function(j) {
      return (j = c.extend({}, i, j)), function(i) {
        ...
        function l(b) {
          ...
          if (j.appendToBody)
            (o.style.top = b.pageY + f + "px"), (o.style.left =
              b.pageX + e + "px");
          else {
            ...
            !0 === j.anchorToPoint &&
              ...
              ), (o.style.top = (d || i) + f + "px"), (o.style.left =
              (c || h) + e + "px");
          }
        }
        var m = j.pointClass;
        ...
        e(o), k("mouseover", m, function(a) {
          ...
          if (
            ...
            if (
              ((n = '<span class="chartist-tooltip-meta">' + n + "</span>"), r)
            )
              f += n + "<br>";
            ...
            s &&
              (
                ...
                (s = '<span class="chartist-tooltip-value">' + s + "</span>"),
                (f += s)
              );
          }
          f &&
