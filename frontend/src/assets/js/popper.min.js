...
!(function(e, t) {
  ...
  function d(e) {
    var n = t(e),
      o = e.offsetWidth,
      r = e.offsetHeight;
    return 1 >= Math.abs(n.width - o) &&
      (o =
        n.width), 1 >= Math.abs(n.height - r) && (r = n.height), { x: e.offsetLeft, y: e.offsetTop, width: o, height: r };
  }
  function m(e) {
    return "html" === s(e)
      ? e
  ...
  function v(e, t) {
    ...
    return (e =
      ...
      (null == (o = e.ownerDocument)
        ? void 0
        : o.body)), (o = n(r)), (r = e ? [o].concat(o.visualViewport || [], l(r) ? r : []) : r), (t = t.concat(r)), e ? t : t.concat(v(m(r)));
  }
  function g(e) {
  ...
  function D(e, t, n) {
    return (t =
      "clippingParents" === t
        ...
        : [].concat(t)), ((n = (n = [].concat(t, [n])).reduce(function(t, n) {
      return (n = E(
        e,
        n
      )), (t.top = _(n.top, t.top)), (t.right = U(n.right, t.right)), (t.bottom = U(n.bottom, t.bottom)), (t.left = _(n.left, t.left)), t;
    }, E(e, n[0]))).width =
      n.right -
      n.left), (n.height = n.bottom - n.top), (n.x = n.left), (n.y = n.top), n;
  }
  function L(e) {
  ...
  function A(e, n) {
    ...
    (p =
      e.rects
        .popper), (a = D(r((c = e.elements[c ? ("popper" === i ? "reference" : "popper") : i])) ? c : c.contextElement || f(e.elements.popper), a, s)), (c = P({ reference: (s = t(l)), element: p, strategy: "absolute", placement: n })), (p = j(Object.assign({}, p, c))), (s = "popper" === i ? p : s);
    var u = {
        ...
        c = {
          ...
          setOptions: function(i) {
            return a(), (s.options = Object.assign(
              ...
              reference: r(e)
                ? v(e)
                : e.contextElement ? v(e.contextElement) : [],
              popper: v(t)
            }), (i = (function(e) {
              var t = b(e);
              ...
              (n =
                void 0 === n
                  ? {}
                  : n), "function" == typeof (e = e.effect) && ((t = e({ state: s, name: t, instance: c, options: n })), f.push(t || function() {}));
            }), c.update();
          },
              ...
              if (W(t, (e = e.popper)))
                for (
                  s.rects = {
                    ...
                    popper: d(e)
                  }, s.reset = !1, s.placement =
                    s.options.placement, s.orderedModifiers.forEach(function(
                    e
                  ) {
                  ...
                  if (!0 === s.reset) (s.reset = !1), (t = -1);
                    ...
                    e = n.fn;
                    var o = n.options;
                    (o = void 0 === o ? {} : o), (n = n.name), "function" ==
                      typeof e &&
                      (s =
  ...
  function T(e) {
    ...
    (e =
      void 0 === (e = (u = e).x) ? 0 : e), (u = void 0 === (u = u.y) ? 0 : u);
    ...
    if (l) {
      ...
      b === n(o) &&
        ("static" !== c((b = f(o))).position &&
          ((w = "scrollHeight"), (x = "scrollWidth"))), "top" === i &&
        ((v = "bottom"), (u -= b[w] - r.height), (u *= p ? 1 : -1)), "left" ===
        i && ((h = "right"), (e -= b[x] - r.width), (e *= p ? 1 : -1));
    }
    return (o = Object.assign(
      { position: s },
      l && J
    )), p ? Object.assign({}, o, (((m = {})[v] = a ? "0" : ""), (m[h] = d ? "0" : ""), (m.transform = 2 > (g.devicePixelRatio || 1) ? "translate(" + e + "px, " + u + "px)" : "translate3d(" + e + "px, " + u + "px, 0)"), m)) : Object.assign({}, o, (((t = {})[v] = a ? u + "px" : ""), (t[h] = d ? e + "px" : ""), (t.transform = ""), t));
  }
  function H(e) {
      ...
      fn: function(e) {
        var t = e.state,
          ...
          r = (e = V.reduce(function(e, n) {
            ...
            return (r =
              (r = s[0]) ||
              0), (s = ((s = s[1]) || 0) * a), (i = 0 <= ["left", "right"].indexOf(i) ? { x: s, y: r } : { x: r, y: s }), (e[n] = i), e;
          }, {}))[t.placement],
          i = r.x;
        (r = r.y), null != t.modifiersData.popperOffsets &&
          (
      ...
      fn: function(e) {
        ...
        if (((s = { x: 0, y: 0 }), a)) {
          if (r || i) {
            ...
            (v = P[v]), (g = P[g]), (m = _(0, U(u[b], m[b]))), (D = c
              ? u[b] / 2 - E - m - v - h
              : D - m - v - h), (u = c
              ? -u[b] / 2 + E + m + g + h
              : p + m + g + h), (c =
              t.elements.arrow && y(t.elements.arrow)), (h = t.modifiersData
              .offset
              ...
              h -
              (c
                ? "y" === l ? c.clientTop || 0 : c.clientLeft || 0
                : 0)), (u = a[l] + u - h), r &&
              (
                (r = o ? U(O, c) : O),
                (j = o ? _(j, u) : j),
        ...
        if (
          ...
          var f = d(i),
            ...
            l =
              ...
              a[e] -
              n.rects.popper[s];
          (a = a[e] - n.rects.reference[e]), (a =
            (i = (i = y(i))
              ? "y" === e ? i.clientHeight || 0 : i.clientWidth || 0
              : 0) /
              2 -
            f[s] / 2 +
            (l / 2 - a / 2)), (s = _(
