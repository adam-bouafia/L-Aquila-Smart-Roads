var Notyf = (function() {
  ...
  var c = {
    ...
    p = (
      ...
      (d.prototype.addNotification = function(t) {
        ...
        this.notifications.push({ notification: t, node: i }), this._announce(
          t.options.message || "Notification"
        );
      }),
      ...
      (d.prototype.getXPosition = function(t) {
        var i;
        return (
          (null === (i = null == t ? void 0 : t.position) || void 0 === i
            ? void 0
            : i.x) || "right"
        );
      }),
      ...
      (d.prototype._buildNotificationCard = function(n) {
        ...
        e &&
          ...
          (
            ...
            (l = null !== (t = e.color) && void 0 !== t ? t : h) &&
              (d.style.color = l),
            p.appendChild(d),
            r.appendChild(p)
          ), r.appendChild(c), s.appendChild(r), h &&
          (i.ripple
            ? ((a.style.background = h), s.appendChild(a))
            : (s.style.background = h)), i.dismissible &&
          (
            ...
            f.addEventListener("click", function(t) {
              var i, e;
              null !== (e = (i = o.events)[v.Dismiss]) &&
                void 0 !== e &&
                e.call(i, { target: n, event: t }), t.stopPropagation();
            })
      ...
      (d.prototype._createA11yContainer = function() {
        ...
        t.setAttribute("aria-atomic", "true"), t.setAttribute(
          "aria-live",
          "polite"
        ), (t.style.border = "0"), (t.style.clip =
          "rect(0 0 0 0)"), (t.style.height = "1px"), (t.style.margin =
          "-1px"), (t.style.overflow = "hidden"), (t.style.padding =
          "0"), (t.style.position = "absolute"), (t.style.width =
          "1px"), (t.style.outline = "0"), document.body.appendChild(
          t
  ...
  function d() {
    ...
    t.appendChild(i), document.body.appendChild(
      t
    ), (this.container = i), (this.animationEndEventName = this._getAnimationEndEventName()), this._createA11yContainer();
  }
  function l(t) {
    var n = this;
    ...
    (this.options = o(
      o({}, c),
      t
    )), (this.options.types = i), this.notifications.onUpdate(function(t, i) {
