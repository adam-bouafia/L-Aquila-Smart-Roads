  ...
  return (function(a, b) {
    ...
    (b.namespaces = {
      ...
      for (a = a || {}, c = 1; c < arguments.length; c++) {
        d = arguments[c];
        for (var f in d)
          (e = d[f]), "object" != typeof e || null === e || e instanceof Array
            ? (a[f] = e)
            : (a[f] = b.extend(a[f], e));
      }
      return a;
    ...
    }), (b.precision = 8), (b.escapingMap = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#039;" }), (b.serialize = function(
      a
    ) {
      ...
      var f;
      return (c = c || "100%"), (d = d || "100%"), Array.prototype.slice
        ...
        .attr({ width: c, height: d })
        .addClass(
          e
        )), (f._node.style.width = c), (f._node.style.height = d), a.appendChild(
        f._node
      ), f;
      ...
      return (f.normalized.series = b.getDataArray(
        ...
        : f.normalized.series.length), (f.normalized.labels = (a.labels || [])
        .slice()), Array.prototype.push.apply(
        f.normalized.labels,
        ...
        if (!b.isDataHoleValue(a)) {
          if (d) {
            ...
            return "string" == typeof d
              ...
              : (c.y = b.getNumberOrUndefined(a)), (c.x = a.hasOwnProperty("x")
              ? b.getNumberOrUndefined(a.x)
              : c.x), (c.y = a.hasOwnProperty("y")
      ...
      var f = {
        ...
        g = void 0 === c.high,
        h = void 0 === c.low;
      return (g || h) && e(a), (c.referenceValue || 0 === c.referenceValue) &&
        (
        ...
        (0 === f.low
          ...
          : f.low < 0
            ? (f.high = 0)
            : f.high > 0 ? (f.low = 0) : ((f.high = 1), (f.low = 0))), f;
      ...
      (k.valueRange = k.high - k.low), (k.oom = b.orderOfMagnitude(
        k.valueRange
      )), (k.step = Math.pow(10, k.oom)), (k.min =
        Math.floor(k.low / k.step) * k.step), (k.max =
        Math.ceil(k.high / k.step) * k.step), (k.range =
        k.max - k.min), (k.numberOfSteps = Math.round(k.range / k.step));
      ...
      (h = Math.max(h, f + j.left + j.right)), (i = Math.max(
        i,
        g + j.top + j.bottom
      ));
      var k = {
      ...
      var j = {};
      (j[d.units.pos + "1"] = a), (j[d.units.pos + "2"] = a), (j[
        d.counterUnits.pos + "1"
      ] = e), (j[d.counterUnits.pos + "2"] = e + f);
      var k = g.elem("line", j, h.join(" "));
      i.emit(
        "draw",
        b.extend({ type: "grid", axis: d, index: c, group: g, element: k }, j)
      );
      ...
      if (
        ...
        (p.className = k.join(" ")), p.setAttribute(
          "xmlns",
          b.namespaces.xhtml
        ), (p.innerText = f[e]), (p.style[g.units.len] =
          Math.round(o[g.units.len]) + "px"), (p.style[g.counterUnits.len] =
          Math.round(o[g.counterUnits.len]) + "px"), (n = j.foreignObject(
          p,
      ...
      function f(a) {
        ...
        e &&
          a &&
          e.emit("optionsChanged", { previousOptions: f, currentOptions: h });
      }
      function g() {
    ...
    (b.Interpolation = {}), (b.Interpolation.none = function(a) {
      ...
      return (a = b.extend({}, c, a)), function d(c, e) {
        ...
        if (f.length) {
          ...
          for (h = 0; h < l - 1; h++)
            (o[h] = k[h + 1] - k[h]), (p[h] = j[h + 1] - j[h]), (n[h] =
              o[h] / p[h]);
    ...
    function d(a, c) {
      ...
      var f = function() {
        ...
        return (a = this === b ? Object.create(e) : this), c.apply(
          a,
    ...
    function d() {
      return this.initializeTimeoutId
    ...
    function g() {
      i.addEventListener(
        "resize",
        this.resizeListener
      ), (this.optionsProvider = b.optionsProvider(this.options, this.responsiveOptions, this.eventEmitter)), this.eventEmitter.addEventHandler(
        "optionsChanged",
        function() {
          this.update();
        }.bind(this)
        ...
        ), this.eventEmitter.emit("data", { type: "initial", data: this.data }), this.createChart(this.optionsProvider.getCurrentOptions()), (this.initializeTimeoutId = void 0);
    }
    function h(a, c, d, e, f) {
      (this.container = b.querySelector(
        a
      )), (this.data = c || {}), (this.data.labels = this.data.labels || []), (this.data.series = this.data.series || []), (this.defaultOptions = d), (this.options = e), (this.responsiveOptions = f), (this.eventEmitter = b.EventEmitter()), (this.supportsForeignObject = b.Svg.isSupported("Extensibility")), (this.supportsAnimations = b.Svg.isSupported("AnimationEventsAttribute")), (this.resizeListener = function() {
        this.update();
      }.bind(
        this
      )), this.container && (this.container.__chartist__ && this.container.__chartist__.detach(), (this.container.__chartist__ = this)), (this.initializeTimeoutId = setTimeout(g.bind(this), 0));
    }
    var i = a.window;
    ...
    function d(a, c) {
      return "string" == typeof a
        ? c ? this._node.getAttributeNS(c, a) : this._node.getAttribute(a)
        : (
    ...
    function p(a, b) {
      return b && this._node.firstChild
        ? this._node.insertBefore(a._node, this._node.firstChild)
        : this._node.appendChild(a._node), this;
    }
    function q() {
    ...
    function w(a, c, d) {
      return void 0 === c && (c = !0), Object.keys(a).forEach(
        function(e) {
          function f(a, c) {
            var f,
              g,
            ...
            a.easing &&
              (
                ...
                delete a.easing
              ), (a.begin = b.ensureUnit(a.begin, "ms")), (a.dur = b.ensureUnit(
              a.dur,
              "ms"
            )), h &&
              (
    ...
    function l(a) {
      ...
      return Array.prototype.push.apply(
        e,
        d
      ), Array.prototype.splice.apply(this.pathElements, e), (this.pos += d.length), this;
    }
    function m() {
    ...
    function q(a) {
      ...
      return (c.pos = this.pos), (c.pathElements = this.pathElements
        .slice()
        .map(function(a) {
          return b.extend({}, a);
    ...
    function r(a) {
      ...
      return this.pathElements.forEach(function(d) {
        d.command === a.toUpperCase() &&
          ...
          c.push(new b.Svg.Path()), c[c.length - 1].pathElements.push(d);
      }), c;
    }
    function s(a, c, d) {
    ...
    function d(a, c, d, e, f) {
      ...
      h.forEach(
        function(j, k) {
          ...
          (l = h[k + 1]
            ? h[k + 1] - j
            : Math.max(this.axisLength - j, 30)), (b.isFalseyButZero(i[k]) &&
            "" !== i[k]) ||
            (
              "x" === this.units.pos
                ? (
    ...
    function c(a, c, d, e) {
      ...
      (this.bounds = b.getBounds(
        ...
        e.scaleMinSpace || 20,
        e.onlyInteger
      )), (this.range = { min: this.bounds.min, max: this.bounds.max }), b.AutoScaleAxis["super"].constructor.call(this, a, d, this.bounds.values, e);
    }
    function d(a) {
      return (
        this.axisLength *
    ...
    function c(a, c, d, e) {
      var f = e.highLow || b.getHighLow(c, e, a.pos);
      (this.divisor = e.divisor || 1), (this.ticks =
        e.ticks ||
    ...
    function c(a) {
      ...
      (d =
        void 0 === a.axisX.type
          ...
          : a.axisX.type.call(
              ...
              j,
              a.axisX
            )), (f = void 0 === a.axisY.type ? new b.AutoScaleAxis(b.Axis.units.y, c.normalized.series, j, b.extend({}, a.axisY, { high: b.isNumeric(a.high) ? a.high : a.axisY.high, low: b.isNumeric(a.low) ? a.low : a.axisY.low })) : a.axisY.type.call(b, b.Axis.units.y, c.normalized.series, j, a.axisY)), d.createGridAndLabels(g, i, this.supportsForeignObject, a, this.eventEmitter), f.createGridAndLabels(g, i, this.supportsForeignObject, a, this.eventEmitter), a.showGridBackground && b.createGridBackground(g, j, a.classNames.gridBackground, this.eventEmitter), c.raw.series.forEach(
        function(e, g) {
          var i = h.elem("g");
          i.attr({
            ...
            [
              a.classNames.series,
              e.className || a.classNames.series + "-" + b.alphaNumerate(g)
            ].join(" ")
          );
          var k = [],
            l = [];
      ...
      ), this.eventEmitter.emit("created", { bounds: f.bounds, chartRect: j, axisX: d, axisY: f, svg: this.svg, options: a });
    }
    function d(a, c, d, f) {
    ...
    function c(a) {
      ...
      a.distributeSeries
        ...
        : (c = b.normalizeData(
            ...
            a.reverseData,
            a.horizontalBars ? "x" : "y"
          )), (this.svg = b.createSvg(this.container, a.width, a.height, a.classNames.chart + (a.horizontalBars ? " " + a.classNames.horizontalBars : "")));
      ...
      (d.high =
        ...
        (0 === a.high
          ? 0
          : d.high)), (d.low = +a.low || (0 === a.low ? 0 : d.low));
      var j,
        k,
        l,
        m,
      ...
      (k =
        a.distributeSeries && a.stackBars
          ...
          : c.normalized
              .labels), a.horizontalBars ? ((j = m = void 0 === a.axisX.type ? new b.AutoScaleAxis(b.Axis.units.x, c.normalized.series, o, b.extend({}, a.axisX, { highLow: d, referenceValue: 0 })) : a.axisX.type.call(b, b.Axis.units.x, c.normalized.series, o, b.extend({}, a.axisX, { highLow: d, referenceValue: 0 }))), (l = n = void 0 === a.axisY.type ? new b.StepAxis(b.Axis.units.y, c.normalized.series, o, { ticks: k }) : a.axisY.type.call(b, b.Axis.units.y, c.normalized.series, o, a.axisY))) : ((l = m = void 0 === a.axisX.type ? new b.StepAxis(b.Axis.units.x, c.normalized.series, o, { ticks: k }) : a.axisX.type.call(b, b.Axis.units.x, c.normalized.series, o, a.axisX)), (j = n = void 0 === a.axisY.type ? new b.AutoScaleAxis(b.Axis.units.y, c.normalized.series, o, b.extend({}, a.axisY, { highLow: d, referenceValue: 0 })) : a.axisY.type.call(b, b.Axis.units.y, c.normalized.series, o, b.extend({}, a.axisY, { highLow: d, referenceValue: 0 }))));
      ...
      l.createGridAndLabels(
        ...
        a,
        this.eventEmitter
      ), j.createGridAndLabels(f, h, this.supportsForeignObject, a, this.eventEmitter), a.showGridBackground && b.createGridBackground(f, o, a.classNames.gridBackground, this.eventEmitter), c.raw.series.forEach(
        function(d, e) {
          var f,
            h,
          ...
          (f =
            ...
            [
              a.classNames.series,
              d.className || a.classNames.series + "-" + b.alphaNumerate(e)
            ].join(" ")
            ...
            function(g, k) {
              ...
              if (
                ...
                var v = {};
                (v[l.units.pos + "1"] = r[l.units.pos]), (v[l.units.pos + "2"] =
                  r[l.units.pos]), !a.stackBars ||
    ...
    function d(a) {
      ...
      )), (e = b.createChartRect(this.svg, a, f.padding)), (g = Math.min(e.width() / 2, e.height() / 2)), (i =
        a.total ||
      ...
      "%" === m.unit &&
        (m.value *=
          g /
          100), (g -= a.donut && !a.donutSolid ? m.value / 2 : 0), (h = "outside" === a.labelPosition || (a.donut && !a.donutSolid) ? g : "center" === a.labelPosition ? 0 : a.donutSolid ? g - m.value / 2 : g / 2), (h += a.labelOffset);
      ...
      ), a.showLabel && (d = this.svg.elem("g", null, null)), j.raw.series.forEach(
        function(e, f) {
          if (0 !== j.normalized.series[f] || !a.ignoreEmptyValues) {
            k[f].attr({ "ct:series-name": e.name }), k[f].addClass(
              [
                a.classNames.series,
                e.className || a.classNames.series + "-" + b.alphaNumerate(f)
              ].join(" ")
            );
