...
window.Element &&
  ...
  for (
    ...
    (window.requestAnimationFrame =
      window[e[t] + "RequestAnimationFrame"]), (window.cancelAnimationFrame =
  ...
  function(M) {
    ...
    var q = {
      ...
      L = function(e) {
        return e
          ? ((t = e), parseInt(M.getComputedStyle(t).height, 10) + e.offsetTop)
          : 0;
        var t;
      },
      x = function(e, t, n) {
        0 === e && document.body.focus(), n ||
          (
            e.focus(),
    ...
    return function(o, e) {
      ...
      (C.cancelScroll = function(e) {
        ...
        if (c || t) {
            ...
            g = c
              ...
              : (function(e, t, n, o) {
                  ...
                  return (a = Math.max(a - t - n, 0)), o &&
                    (a = Math.min(a, F() - M.innerHeight)), a;
                })(
                  t,
                  p,
                  parseInt(
              ...
              l || (l = e), (w += e - l), (d =
                ...
                y *
                  (
                    ...
                    o || n
                  )), M.scrollTo(0, Math.floor(d)), (function(e, t) {
                var n = M.pageYOffset;
                if (e == t || n == t || (s < t && M.innerHeight + n) >= v)
                  return C.cancelScroll(!0), x(a, t, c), H(
                    "scrollStop",
                    i,
                    a,
                    r
          ...
          0 === M.pageYOffset && M.scrollTo(0, 0), (f = a), (h = i), c ||
            (history.pushState &&
              h.updateURL &&
              history.pushState(
      ...
      return (function() {
        ...
        C.destroy(), (b = I(q, e || {})), (A = b.header
          ? document.querySelector(b.header)
          : null), document.addEventListener("click", t, !1), b.updateURL &&
          b.popstate &&
