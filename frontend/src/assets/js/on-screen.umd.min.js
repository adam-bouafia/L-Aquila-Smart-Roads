!(function(global, factory) {
  ...
  function attach() {
    ...
    container.addEventListener("scroll", this._scroll, {
      passive: !0
    }), window.addEventListener("resize", this._scroll, { passive: !0 }), this._scroll(), (this.attached = !0);
  }
  ...
  function destroy() {
    this.options.container.removeEventListener(
      "scroll",
      this._scroll
    ), window.removeEventListener("resize", this._scroll), (this.attached = !1);
  }
  ...
  function OnScreen() {
    ...
    (this.options = {}), (this.trackedElements = {}), Object.defineProperties(
      this.options,
      {
        container: {
          configurable: !1,
          ...
          get: function() {
            ...
            return "string" == typeof options.container
              ? (container = document.querySelector(options.container))
              : options.container instanceof HTMLElement &&
                (container = options.container), container || window;
          },
          set: function(value) {
    ...
    ), Object.defineProperty(this, "_scroll", { enumerable: !1, configurable: !1, writable: !1, value: this._debouncedScroll.call(this) }), observeDOM(document.querySelector("body"), function() {
