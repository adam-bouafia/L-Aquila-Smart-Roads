...
!(function(e, t) {
  ...
  function s(e, t) {
    for (var i = 0; i < t.length; i++) {
      var s = t[i];
      (s.enumerable = s.enumerable || !1), (s.configurable = !0), "value" in
        s && (s.writable = !0), Object.defineProperty(e, s.key, s);
    }
  }
  var r =
      "object" == typeof global && global && global.Object === Object && global,
    l = "object" == typeof self && self && self.Object === Object && self,
    o = r || l || Function("return this")(),
    n = o.Symbol,
    a = Object.prototype,
    c = a.hasOwnProperty,
    h = a.toString,
  ...
  function E(e) {
    ...
    e = e.replace(m, "");
    var i = b.test(e);
    return i || y.test(e) ? x(e.slice(2), i ? 2 : 8) : g.test(e) ? NaN : +e;
  }
  var O = function() {
      return o.Date.now();
    },
  ...
  function k(e, t, i) {
    ...
    function p(e) {
      return (c = e), (n = setTimeout(g, t)), h ? f(e) : o;
    }
    function m(e) {
      var i = e - a;
      return void 0 === a || i >= t || i < 0 || (d && e - c >= l);
    }
    function g() {
      var e = O();
      if (m(e)) return b(e);
      n = setTimeout(
        ...
        (function(e) {
          var i = t - (e - a);
          return d ? S(i, l - (e - c)) : i;
        })(e)
      );
    }
    function b(e) {
      return (n = void 0), u && s ? f(e) : ((s = r = void 0), o);
    }
    function y() {
      var e = O(),
        i = m(e);
      if (((s = arguments), (r = this), (a = e), i)) {
        if (void 0 === n) return p(a);
        if (d) return clearTimeout(n), (n = setTimeout(g, t)), f(a);
      }
      return void 0 === n && (n = setTimeout(g, t)), o;
    }
    return (t =
      E(t) ||
      0), v(i) && ((h = !!i.leading), (l = (d = "maxWait" in i) ? w(E(i.maxWait) || 0, t) : l), (u = "trailing" in i ? !!i.trailing : u)), (y.cancel = function() {
      void 0 !== n && clearTimeout(n), (c = 0), (s = a = r = n = void 0);
    }), (y.flush = function() {
      return void 0 === n ? o : b(O());
    }), y;
  }
  function A(e, t, i) {
    var s = !0,
    ...
    return v(i) &&
      ...
      ), k(e, t, { leading: s, maxWait: t, trailing: r });
  }
  var L = null,
    M = null;
  function W() {
  ...
  e &&
    window.addEventListener("resize", function() {
      M !== window.devicePixelRatio &&
        ((M = window.devicePixelRatio), (L = null));
    });
  var D = (function() {
    function t(e) {
      var s = this,
        r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      i(this, t), (this.onScroll = function() {
        var e = N(s.el);
        s.scrollXTicking ||
          (
        ...
        s.el.classList.remove(s.classNames.scrolling), (s.isScrolling = !1);
        ...
        s.el.classList.remove(
          s.classNames.mouseEntered
        ), (s.isMouseEntering = !1);
      }), (this.onMouseMove = function(e) {
        (s.mouseX = e.clientX), (s.mouseY = e.clientY), (s.axis.x
          .isOverflowing ||
        ...
        (s.scrollbarWidth = t.getScrollbarWidth()), s.hideNativeScrollbar();
      }), (this.onPointerEvent = function(e) {
        var t, i;
        (s.axis.x.track.rect = s.axis.x.track.el.getBoundingClientRect()), (s.axis.y.track.rect = s.axis.y.track.el.getBoundingClientRect()), (s
          .axis.x.isOverflowing ||
          s.axis.x.forceVisible) &&
          (t = s.isWithinBounds(s.axis.x.track.rect)), (s.axis.y
          .isOverflowing ||
          s.axis.y.forceVisible) &&
        ...
        var i = s.axis[s.draggedAxis].track,
          ...
          l = s.axis[s.draggedAxis].scrollbar,
          o = s.contentWrapperEl[s.axis[s.draggedAxis].scrollSizeAttr],
          n = parseInt(s.elStyles[s.axis[s.draggedAxis].sizeAttr], 10);
        ...
        "x" === s.draggedAxis &&
          (a =
            s.isRtl && t.getRtlHelpers().isScrollOriginAtZero
              ? a - (r + l.size)
              : a), (s.contentWrapperEl[
          s.axis[s.draggedAxis].scrollOffsetAttr
        ] = a);
      }), (this.onEndDrag = function(e) {
        var t = C(s.el),
          i = N(s.el);
        e.preventDefault(), e.stopPropagation(), s.el.classList.remove(
          s.classNames.dragging
          ...
          t.removeEventListener(
            ...
            s.preventClick,
            !0
          ), t.removeEventListener("dblclick", s.preventClick, !0), (s.removePreventClickId = null);
        }));
      }), (this.preventClick = function(e) {
        e.preventDefault(), e.stopPropagation();
      }), (this.el = e), (this.minScrollbarWidth = 20), (this.stopScrollDelay = 175), (this.options = T(
        T({}, t.defaultOptions),
        r
      )), (this.classNames = T(
        {
      ...
      }), (this.removePreventClickId = null), (this.isScrolling = !1), (this.isMouseEntering = !1), t.instances.has(
        this.el
      ) ||
        (
          r.classNames &&
          ...
          (this.onMouseMove = A(this.onMouseMove, 64)),
          (this.onWindowResize = k(this.onWindowResize, 64, { leading: !0 })),
          (this.onStopScrolling = k(
            this.onStopScrolling,
            this.stopScrollDelay
          )),
          (this.onMouseEntered = k(this.onMouseEntered, this.stopScrollDelay)),
          this.init()
        );
    }
    var r, l, o;
    return (r = t), (o = [
    ...
    ]), (l = [
      {
        key: "init",
        value: function() {
          t.instances.set(this.el, this), e &&
            (
              this.initDOM(),
              (this.rtlHelpers = t.getRtlHelpers()),
              (this.scrollbarWidth = t.getScrollbarWidth()),
              this.recalculate(),
              this.initListeners()
            );
        }
      },
      {
        ...
        value: function() {
          ...
          if (
            ...
            for (
              this.wrapperEl = document.createElement(
                "div"
              ), this.contentWrapperEl = document.createElement(
                "div"
              ), this.offsetEl = document.createElement(
                "div"
              ), this.maskEl = document.createElement(
                "div"
              ), this.contentEl = document.createElement(
                "div"
              ), this.placeholderEl = document.createElement(
                "div"
          ...
          if (!this.axis.x.track.el || !this.axis.y.track.el) {
            ...
            t.classList.add(this.classNames.track), i.classList.add(
              this.classNames.scrollbar
            ), t.appendChild(i), (this.axis.x.track.el = t.cloneNode(
              !0
            )), this.axis.x.track.el.classList.add(
              this.classNames.horizontal
            ), (this.axis.y.track.el = t.cloneNode(
              !0
            )), this.axis.y.track.el.classList.add(
              this.classNames.vertical
            ), this.el.appendChild(this.axis.x.track.el), this.el.appendChild(
      ...
      },
      {
        ...
        value: function() {
          var e = N(this.el);
          (this.elStyles = e.getComputedStyle(this.el)), (this.isRtl =
            "rtl" === this.elStyles.direction);
          ...
          (this.contentWrapperEl.style.height = i
            ...
            ? "".concat(t || a, "px")
            : "auto"), (this.placeholderEl.style.height = "".concat(n, "px"));
          var c = this.contentWrapperEl.offsetHeight;
          (this.axis.x.isOverflowing =
            0 !== t && a > t), (this.axis.y.isOverflowing =
            n > c), (this.axis.x.isOverflowing =
            "hidden" !== l &&
            this.axis.x.isOverflowing), (this.axis.y.isOverflowing =
            "hidden" !== o &&
            this.axis.y.isOverflowing), (this.axis.x.forceVisible =
            "x" === this.options.forceVisible ||
            !0 === this.options.forceVisible), (this.axis.y.forceVisible =
            "y" === this.options.forceVisible ||
            !0 === this.options.forceVisible), this.hideNativeScrollbar();
          var h = this.axis.x.isOverflowing ? this.scrollbarWidth : 0,
            d = this.axis.y.isOverflowing ? this.scrollbarWidth : 0;
          (this.axis.x.isOverflowing =
            this.axis.x.isOverflowing &&
            a > r - d), (this.axis.y.isOverflowing =
            this.axis.y.isOverflowing &&
            n > c - h), (this.axis.x.scrollbar.size = this.getScrollbarSize(
            "x"
          )), (this.axis.y.scrollbar.size = this.getScrollbarSize(
            "y"
            ...
            "px"
          )), this.positionScrollbar("x"), this.positionScrollbar(
            "y"
      ...
      },
      {
        ...
        value: function() {
          ...
          var t,
            ...
            r = s / i;
          return (t = Math.max(~~(r * s), this.options.scrollbarMinSize)), this
            .options.scrollbarMaxSize &&
            (t = Math.min(t, this.options.scrollbarMaxSize)), t;
        }
      },
      {
            ...
            var i = this.contentWrapperEl[this.axis[e].scrollSizeAttr],
              ...
              n =
                (o =
                  "x" === e &&
                  this.isRtl &&
                  t.getRtlHelpers().isScrollOriginAtZero
                    ? -o
                    : o) /
                (i - r),
              a = ~~((s - l.size) * n);
            (a =
              "x" === e && this.isRtl && t.getRtlHelpers().isScrollingToNegative
                ? -a + (s - l.size)
                : a), (l.el.style.transform =
              "x" === e
                ? "translate3d(".concat(a, "px, 0, 0)")
      ...
      },
      {
        ...
        value: function() {
          ...
          (this.axis[e].track.rect = this.axis[
            e
          ].track.el.getBoundingClientRect()), (this.axis[
            e
          ].scrollbar.rect = this.axis[e].scrollbar.el.getBoundingClientRect());
      ...
      },
      {
        ...
        value: function(e) {
          ...
          (this.axis[t].dragOffset =
            ...
            ]), (this.draggedAxis = t), this.el.classList.add(
            this.classNames.dragging
          ), i.addEventListener("mousemove", this.drag, !0), i.addEventListener(
            "mouseup",
            this.onEndDrag,
            !0
      ...
      },
      {
        ...
        value: function(e) {
          ...
          if (this.options.clickOnTrack) {
            ...
            var r = this.axis[i].scrollbar,
              l = r.rect[this.axis[i].offsetAttr],
              o = parseInt(this.elStyles[this.axis[i].sizeAttr], 10),
              n = this.contentWrapperEl[this.axis[i].scrollOffsetAttr],
              a = "y" === i ? this.mouseY - l : this.mouseX - l,
              c = a < 0 ? -1 : 1,
              h = -1 === c ? n - o : n + o,
              d = 40,
              u = function e() {
                -1 === c
                  ? n > h &&
                    (
                      (n -= d),
                      (t.contentWrapperEl[t.axis[i].scrollOffsetAttr] = n),
      ...
      },
      {
        ...
        value: function() {
          ...
          this.el.removeEventListener(
            ...
            "mousemove",
            this.onMouseMove
          ), this.el.removeEventListener("mouseleave", this.onMouseLeave), this
            .contentWrapperEl &&
            this.contentWrapperEl.removeEventListener(
              "scroll",
              this.onScroll
            ), e.removeEventListener("resize", this.onWindowResize), this
            .mutationObserver && this.mutationObserver.disconnect(), this
            .resizeObserver &&
  ...
  return (D.initDOMLoadedElements = function() {
    ...
    (this.initDOMLoadedElements = this.initDOMLoadedElements.bind(
      ...
      (
        (this.globalObserver = new MutationObserver(D.handleMutations)),
  ...
  }), (D.handleMutations = function(e) {
    e.forEach(function(e) {
      Array.prototype.forEach.call(e.addedNodes, function(e) {
        1 === e.nodeType &&
          (e.hasAttribute("data-simplebar")
            ? !D.instances.has(e) && new D(e, R(e.attributes))
            : Array.prototype.forEach.call(
        ...
        1 === e.nodeType &&
          (e.hasAttribute("data-simplebar")
            ? D.instances.has(e) && D.instances.get(e).unMount()
            : Array.prototype.forEach.call(
  ...
  }), (D.getOptions = R), (D.default = D), e && D.initHtmlApi(), D;
});
