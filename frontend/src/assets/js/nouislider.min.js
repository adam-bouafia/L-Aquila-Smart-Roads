...
!(function(a) {
  ...
  function f(a, b) {
    ...
    return /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) &&
      (f.x = 0), b ? c.top + f.y - e.clientTop : c.left + f.x - e.clientLeft;
  }
  function g(a) {
  ...
  function A(a, b, c) {
    ...
    c.xPct.push(
      d
    ), c.xVal.push(b[0]), d ? c.xSteps.push(!isNaN(b[1]) && b[1]) : isNaN(b[1]) || (c.xSteps[0] = b[1]), c.xHighestCompleteStep.push(0);
  }
  function B(a, b, c) {
    if (!b) return !0;
    c.xSteps[a] =
  ...
  function W(a) {
    ...
    a.format && !a.ariaFormat && (a.ariaFormat = a.format), Object.keys(
      c
    ).forEach(function(e) {
  ...
  function X(a, e, g) {
    ...
    function s(a, b) {
      ...
      return d.setAttribute(
        "data-handle",
        b
      ), d.setAttribute("tabindex", "0"), d.setAttribute("role", "slider"), d.setAttribute("aria-orientation", e.ort ? "vertical" : "horizontal"), 0 === b ? l(d, e.cssClasses.handleLower) : b === e.handles - 1 && l(d, e.cssClasses.handleUpper), c;
    }
    function t(a, b) {
    ...
    function v(a) {
      l(
        a,
        e.cssClasses.target
      ), 0 === e.dir ? l(a, e.cssClasses.ltr) : l(a, e.cssClasses.rtl), 0 === e.ort ? l(a, e.cssClasses.horizontal) : l(a, e.cssClasses.vertical), (ja = k(a, e.cssClasses.base));
    }
    function w(a, b) {
    ...
    function x() {
      ...
      Q("update", function(b, c, d) {
        if (a[c]) {
          var f = b[c];
          !0 !== e.tooltips[c] && (f = e.tooltips[c].to(d[c])), (a[
            c
          ].innerHTML = f);
        }
      });
      ...
      Q("update", function(a, b, c, d, f) {
        ta.forEach(function(a) {
          ...
          b.children[0].setAttribute(
            "aria-valuemin",
            d.toFixed(1)
          ), b.children[0].setAttribute("aria-valuemax", g.toFixed(1)), b.children[0].setAttribute("aria-valuenow", h.toFixed(1)), b.children[0].setAttribute("aria-valuetext", i);
        });
      });
    }
    function z(a, b, c) {
    ...
    function A(a, b, c) {
      ...
      return (c = d(
        ...
        (
          c.unshift(g),
          (i = !0)
        ), c[c.length - 1] !== h && (c.push(h), (j = !0)), c.forEach(function(
        d,
        g
      ) {
        var h,
        ...
        if (
          ...
          for (h = Math.max(h, 1e-7), l = u; l <= v; l = e(l, h)) {
            for (
              n = va.toStepping(l), o = n - k, r = o / a, s = Math.round(r), t =
                o / s, m = 1;
              m <= s;
              m += 1
            )
              (p = k + m * t), (f[p.toFixed(5)] = ["x", 0]);
            (q = c.indexOf(l) > -1 ? 1 : "steps" === b ? 2 : 0), !g &&
              i &&
              (q = 0), (l === v && j) || (f[n.toFixed(5)] = [l, q]), (k = n);
          }
      }), f;
    }
    function B(a, b, c) {
      ...
      function f(a, f) {
        ...
        (h.className = d(
          f[1],
          e.cssClasses.marker
        )), (h.style[e.style] = a + "%"), f[1] && ((h = k(g, !1)), (h.className = d(f[1], e.cssClasses.value)), h.setAttribute("data-value", f[0]), (h.style[e.style] = a + "%"), (h.innerText = c.to(f[0])));
      }
      ...
      return l(
        g,
        e.cssClasses.pips
      ), l(g, 0 === e.ort ? e.cssClasses.pipsHorizontal : e.cssClasses.pipsVertical), Object.keys(
        a
      ).forEach(function(b) {
        f(b, a[b]);
      }), g;
    ...
    function G(a, b, c) {
      ...
      return (b =
        ...
        o(
          ya
        )), (g || h) && ((d = a.clientX + b.x), (e = a.clientY + b.y)), (a.pageOffset = b), (a.points = [d, e]), (a.cursor = g || h), a;
    }
    function H(a) {
      var b = a - f(ja, e.ort),
        c = 100 * b / E();
    ...
    function L(a, b) {
      b.handle &&
        (
          m(b.handle, e.cssClasses.active),
          (ua -= 1)
    ...
    function M(a, b) {
      ...
      g.push.apply(
        g,
        h.concat(i, j)
      ), a.cursor && ((Aa.style.cursor = getComputedStyle(a.target).cursor), ka.length > 1 && l(ra, e.cssClasses.drag), Aa.addEventListener("selectstart", c, !1)), b.handleNumbers.forEach(
        function(a) {
          S("start", a);
        }
      );
    ...
    function N(a) {
      ...
      e.events.snap ||
        h(
          ...
          e.cssClasses.tap,
          e.animationDuration
        ), aa(c, b, !0, !0), _(), S("slide", c, !0), S("update", c, !0), S("change", c, !0), S("set", c, !0), e.events.snap && M(a, { handleNumbers: [c] });
    }
    function O(a) {
      var b = H(a.calcPoint),
        c = va.getStep(b),
    ...
    function P(a) {
      a.fixed ||
        ...
        F(
          ...
          N,
          {}
        ), a.hover && F(oa.move, ja, O, { hover: !0 }), a.drag &&
        la.forEach(function(b, c) {
          if (!1 !== b && 0 !== c && c !== la.length - 1) {
            var d = ka[c - 1],
              f = ka[c],
              g = [b];
            l(b, e.cssClasses.draggable), a.fixed &&
              (
                g.push(d.children[0]),
                g.push(f.children[0])
    ...
    function Q(a, b) {
      (xa[a] = xa[a] || []), xa[a].push(b), "update" === a.split(".")[0] &&
        ka.forEach(function(a, b) {
          S("update", b);
        });
    }
    ...
    function U(a, b, c, d, f, g) {
      return ka.length > 1 &&
        ...
        ), ka.length > 1 && e.limit && (d && b > 0 && (c = Math.min(c, a[b - 1] + e.limit)), f && b < ka.length - 1 && (c = Math.max(c, a[b + 1] - e.limit))), e.padding && (0 === b && (c = Math.max(c, e.padding[0])), b === ka.length - 1 && (c = Math.min(c, 100 - e.padding[1]))), (c = va.getStep(c)), !((c = i(c)) === a[b] && !g) && c;
    }
    function V(a, b) {
      var c = e.ort;
      return (c ? b : a) + ", " + (c ? a : b);
    ...
    function X(a, b, c, d) {
      var e = c.slice(),
        f = [!a, a],
        g = [a, !a];
      (d = d.slice()), a && d.reverse(), d.length > 1
    ...
    function da(a, b) {
      ...
      (b =
        void 0 === b ||
        !!b), e.animate && !d && h(ra, e.cssClasses.tap, e.animationDuration), ta.forEach(
        function(a) {
          aa(a, ca(c[a], a), !0, !1);
        }
      ), ta.forEach(function(a) {
    ...
    function ha() {
      return sa.map(function(a, b) {
        ...
        !1 !== e &&
          ...
          (e =
            c.stepAfter.startValue -
            d), (f = d > c.thisStep.startValue ? c.thisStep.step : !1 !== c.stepBefore.step && d - c.stepBefore.highestStep), 100 === a ? (e = null) : 0 === a && (f = null);
        var g = va.countStepDecimals();
        return null !== e &&
          !1 !== e &&
          (e = Number(
            e.toFixed(g)
          )), null !== f && !1 !== f && (f = Number(f.toFixed(g))), [f, e];
      });
    }
    function ia(a, b) {
      var c = fa(),
      ...
      d.forEach(function(b) {
        ...
        f.spectrum), (e.margin = f.margin), (e.limit = f.limit), (e.padding = f.padding), e.pips && D(e.pips), (sa = []), da(a.start || c, b);
    }
    var ja,
      ka,
      la,
