!(function(e, t) {
  ...
  const l = Object.freeze({
    ...
    i = (e, t) => {
      (t = '"'
        ...
        .concat(t, '" instead.')), n.includes(t) || (n.push(t), s(t));
    },
  ...
  const H = { previousBodyPadding: null },
    V = (t, e) => {
      if (((t.textContent = ""), e)) {
    ...
    se = e => {
      ...
      if (oe()) r("SweetAlert2 requires document to initialize");
        ...
        o.appendChild(n), (e => {
          const t = v();
          t.setAttribute("role", e.toast ? "alert" : "dialog"), t.setAttribute(
            "aria-live",
            e.toast ? "polite" : "assertive"
          ), e.toast || t.setAttribute("aria-modal", "true");
        })(e), (e = o), "rtl" === window.getComputedStyle(e).direction &&
          W(b(), h.rtl), (() => {
          const e = v(),
            t = K(e, h.input),
            n = K(e, h.file),
    ...
    re = (e, t) => {
      e instanceof HTMLElement
        ? t.appendChild(e)
        : "object" == typeof e ? ce(e, t) : e && V(t, e);
    },
    ce = (e, t) => {
    ...
    de = (e, t) => {
      ...
      var o = S(),
        ...
        a = E(),
        s = O();
      t.showConfirmButton || t.showDenyButton || t.showCancelButton || J(n), U(
        n,
        t,
        "actions"
      ), pe(i, "confirm", t), pe(a, "deny", t), pe(s, "cancel", t), (function(
        e,
        t,
        n,
        o
        ...
        W([e, t, n], h.styled), o.confirmButtonColor &&
          (
      ...
      })(i, a, s, t), t.reverseButtons &&
        (n.insertBefore(s, o), n.insertBefore(a, o), n.insertBefore(i, o)), V(
        o,
        t.loaderHtml
      ), U(o, t, "loader");
    };
  function pe(e, t, n) {
    X(
      e,
      n["show".concat(o(t), "Button")],
      "inline-block"
    ), V(e, n["".concat(t, "ButtonText")]), e.setAttribute("aria-label", n["".concat(t, "ButtonAriaLabel")]), (e.className = h[t]), U(e, n, "".concat(t, "Button")), W(e, n["".concat(t, "ButtonClass")]);
  }
  const me = (e, t) => {
    var n,
      o,
  ...
  const ge = [
    ...
    we = (e, t, n) => {
      if (n.inputLabel) {
        ...
        var o = h["input-label"];
        i.setAttribute("for", e.id), (i.className = o), W(
          i,
          n.customClass.inputLabel
        ), (i.innerText = n.inputLabel), t.insertAdjacentElement(
          "beforebegin",
          i
        );
      }
  ...
  (ke.text = ke.email = ke.password = ke.number = ke.tel = ke.url = (e, t) => (
    ...
    (e.type = t.input),
    e
  )), (ke.file = (e, t) => (we(e, e, t), ve(e, t), e)), (ke.range = (e, t) => {
    const n = e.querySelector("input"),
      o = e.querySelector("output");
    return (n.value = t.inputValue), (n.type = t.input), (o.value =
      t.inputValue), we(n, e, t), e;
  }), (ke.select = (e, t) => {
    if (((e.textContent = ""), t.inputPlaceholder)) {
      const n = document.createElement("option");
      V(n, t.inputPlaceholder), (n.value =
        ""), (n.disabled = !0), (n.selected = !0), e.appendChild(n);
    }
    return we(e, e, t), e;
  ...
  const Ae = (e, t) => {
      const n = k();
      U(n, t, "htmlContainer"), t.html
        ? (re(t.html, n), Z(n, "block"))
        : t.text ? ((n.textContent = t.text), Z(n, "block")) : J(n), ((
        e,
        o
      ) => {
        const i = v();
    ...
    Oe = (e, o) => {
      ...
      Z(i), (i.textContent = ""), o.currentProgressStep >=
        o.progressSteps.length &&
        s(
        ...
        i.appendChild(e), t === o.currentProgressStep &&
          W(e, h["active-progress-step"]), t !== o.progressSteps.length - 1 &&
          (
            (t = (e => {
              const t = document.createElement("li");
              return W(t, h["progress-step-line"]), e.progressStepsDistance &&
                (t.style.width = e.progressStepsDistance), t;
            })(o)),
            i.appendChild(t)
          );
      });
    ...
    Te = (e, t) => {
      (e.className = ""
        .concat(h.popup, " ")
        .concat(G(e) ? t.showClass.popup : "")), t.toast
        ? (
            W([document.documentElement, document.body], h["toast-shown"]),
            W(e, h.toast)
          )
        : W(e, h.modal), U(e, t, "popup"), "string" == typeof t.customClass &&
        W(e, t.customClass), t.icon && W(e, h["icon-".concat(t.icon)]);
    },
    Le = (e, t) => {
      var n, o, i;
      (e => {
        ...
        e.toast
          ...
          : Y(n, "width", e.width), Y(n, "padding", e.padding), e.background &&
          (n.style.background = e.background), J(x()), Te(n, e);
      })(t), me(0, t), Oe(0, t), (i = e), (n = t), (o = he.innerParams.get(
        i
      )), (i = w()), o && n.icon === o.icon
        ? (Pe(i, n), Be(i, n))
        : n.icon || n.iconHtml
        ...
        Z(t, ""), t.setAttribute("src", e.imageUrl), t.setAttribute(
          "alt",
          e.imageAlt
        ), Y(t, "width", e.imageWidth), Y(
          t,
          "height",
          e.imageHeight
        ), (t.className = h.image), U(t, e, "image");
      })(t), (e => {
        const t = C();
        X(t, e.title || e.titleText, "block"), e.title &&
          re(e.title, t), e.titleText && (t.innerText = e.titleText), U(
          t,
          e,
          "title"
        );
        ...
        const t = D();
        V(t, e.closeButtonHtml), U(t, e, "closeButton"), X(
          t,
          e.showCloseButton
        ), t.setAttribute("aria-label", e.closeButtonAriaLabel);
      })(t), Ae(e, t), de(0, t), (i = t), (e = L()), X(e, i.footer), i.footer &&
        re(i.footer, e), U(e, i, "footer"), "function" == typeof t.didRender &&
        t.didRender(v());
    };
  const je = () => P() && P().click();
  const De = e => {
      ...
      t || cn.fire(), (t = v());
      var n = S();
      q() ? J(w()) : Ie(t, e), Z(n), t.setAttribute(
        "data-loading",
        !0
    ...
    Ie = (e, t) => {
      ...
      !t && G(P()) && (t = P()), Z(n), t &&
        ...
        ), o.parentNode.insertBefore(o, t), W([e, n], h.loading);
    },
    Me = {},
    qe = o =>
      new Promise(e => {
        ...
        (Me.restoreFocusTimeout = setTimeout(() => {
          Me.previousActiveElement && Me.previousActiveElement.focus
            ...
            : document.body && document.body.focus(), e();
      ...
      if (Me.timeout)
        return (() => {
          ...
          var n = parseInt(window.getComputedStyle(e).width),
            n = parseInt(t / n * 100);
          e.style.removeProperty("transition"), (e.style.width = "".concat(
            n,
            "%"
          ));
        })(), Me.timeout.stop();
  ...
  const Ye = e => We[e],
    Ze = e => {
      for (const o in e)
        (n = o), Ke(n) || s('Unknown parameter "'.concat(n, '"')), e.toast &&
          (
            (t = o),
            _e.includes(t) &&
  ...
  var Je = Object.freeze({
    ...
    argsToParams: n => {
      const o = {};
      return "object" != typeof n[0] || m(n[0])
    ...
    bindClickHandler: function(e = "data-swal-template") {
      (Ue[e] = this), Ne ||
        (document.body.addEventListener("click", Fe), (Ne = !0));
    }
  });
  function $e() {
    ...
    if (e) {
      ...
      J(t.loader), q()
        ...
        : (e => {
          ...
          })(t), _([t.popup, t.actions], h.loading), t.popup.removeAttribute(
        "aria-busy"
      ), t.popup.removeAttribute(
        "data-loading"
      ), (t.confirmButton.disabled = !1), (t.denyButton.disabled = !1), (t.cancelButton.disabled = !1);
    }
  }
  const Xe = () => {
          ...
          (document.body.style.paddingRight = "".concat(
            H.previousBodyPadding +
              (() => {
                ...
                (e.className =
                  h["scrollbar-measure"]), document.body.appendChild(e);
    ...
    et = e => {
      ...
      return (
        ...
        !nt(e) &&
        (t === n ||
          !(ee(n) || "INPUT" === t.tagName || (ee(k()) && k().contains(t))))
      );
    },
    tt = e =>
  ...
  const st = (e, t, n, o, i) => {
      (Me.swalCloseEventFinishedCallback = it.bind(
        null,
        e,
        n,
        o,
  ...
  class ut {
    ...
    increase(e) {
      var t = this.running;
      return t &&
        this.stop(), (this.remaining += e), t && this.start(), this.remaining;
    }
    getTimerLeft() {
  ...
  const mt = ["swal-title", "swal-html", "swal-footer"],
    ...
    gt = e => {
      ...
      return a(e.querySelectorAll("swal-param")).forEach(e => {
        ...
        "boolean" == typeof Re[t] && "false" === n && (n = !1), "object" ==
          typeof Re[t] && (n = JSON.parse(n)), (o[t] = n);
      }), o;
    },
    bt = e => {
      const n = {};
      return a(e.querySelectorAll("swal-button")).forEach(e => {
        ...
        (n["".concat(t, "ButtonText")] = e.innerHTML), (n[
          "show".concat(o(t), "Button")
        ] = !0), e.hasAttribute("color") &&
          (n["".concat(t, "ButtonColor")] = e.getAttribute(
            "color"
    ...
    At = e => {
      ...
      Et(t, n, e), setTimeout(() => {
        ...
        (Me.previousActiveElement = document.activeElement), "function" ==
        typeof e.didOpen && setTimeout(() => e.didOpen(n)), _(
        t,
        h["no-transition"]
      );
    },
    ...
    Pt = (e, t, n) => {
      ...
      ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) ||
        ...
        (
          ...
          Qe(),
          Ge()
        ), t && "hidden" !== n && Xe(), setTimeout(() => {
        e.scrollTop = 0;
      });
    },
    Et = (e, t, n) => {
      W(e, n.showClass.backdrop), t.style.setProperty(
        "opacity",
        "0",
        "important"
      ), Z(t, "grid"), setTimeout(() => {
    ...
    Tt = e =>
      e.files.length
        ? null !== e.getAttribute("multiple") ? e.files : e.files[0]
        : null,
    Lt = (t, n) => {
      const o = v(),
    ...
    jt = (t, n) => {
      ...
      J(o), d(n.inputValue)
        .then(e => {
          (o.value =
            "number" === n.input ? parseFloat(e) || 0 : "".concat(e)), Z(
            o
          ), o.focus(), t.hideLoading();
        })
        .catch(e => {
          r("Error in inputValue promise: ".concat(e)), (o.value = ""), Z(
            o
          ), o.focus(), t.hideLoading();
        });
    },
    Dt = {
      select: (e, t, i) => {
        ...
        t.forEach(e => {
          ...
          if (Array.isArray(n)) {
            ...
            (o.label = t), (o.disabled = !1), a.appendChild(o), n.forEach(e =>
              s(o, e[1], e[0])
            );
          } else s(a, n, t);
        }), a.focus();
      ...
      radio: (e, t, a) => {
        ...
        t.forEach(e => {
          ...
          (n.type = "radio"), (n.name = h.radio), (n.value = t), Mt(
            t,
            a.inputValue
          ) && (n.checked = !0);
          const i = document.createElement("span");
          V(i, e), (i.className = h.label), o.appendChild(n), o.appendChild(
            i
          ), s.appendChild(o);
        });
    ...
    It = n => {
      const o = [];
      return "undefined" != typeof Map && n instanceof Map
        ? n.forEach((e, t) => {
            let n = e;
            "object" == typeof n && (n = It(n)), o.push([t, n]);
          })
        : Object.keys(n).forEach(e => {
            let t = n[e];
            "object" == typeof t && (t = It(t)), o.push([e, t]);
          }), o;
    },
    ...
    Ht = (t, n, o, i) => {
      ...
      e.then(e => {
        t.enableButtons(), t.enableInput(), e
    ...
    Kt = (e, t) => {
      ...
      e.shiftKey
        ? Ft(0, i, -1)
        : Ft(0, i, 1), e.stopPropagation(), e.preventDefault();
    },
    Yt = e => {
      const t = P(),
        n = E(),
    ...
    Gt = t => {
      t.container.onmousedown = () => {
        t.popup.onmouseup = function(e) {
          (t.popup.onmouseup = void 0), (e.target !== t.popup &&
  ...
  e = Object.freeze({
    ...
    showValidationMessage: function(e) {
      const t = he.domCache.get(this);
      var n = he.innerParams.get(this);
      V(t.validationMessage, e), (t.validationMessage.className =
        h["validation-message"]), n.customClass &&
        n.customClass.validationMessage &&
        W(t.validationMessage, n.customClass.validationMessage), Z(
        t.validationMessage
      );
    ...
    _main: function(e, t = {}) {
      Ze(Object.assign({}, t, e)), Me.currentInstance &&
        Me.currentInstance._destroy(), (Me.currentInstance = this), pt(
        (e = ((e, t) => {
          const n = ht(e),
          ...
          return (o.showClass = Object.assign(
            ...
            Re.showClass,
            o.showClass
          )), (o.hideClass = Object.assign({}, Re.hideClass, o.hideClass)), o;
        })(e, t))
      ), Object.freeze(e), Me.timeout &&
        (Me.timeout.stop(), delete Me.timeout), clearTimeout(
        Me.restoreFocusTimeout
      );
      var s,
        r,
        c,
      ...
      return Le(this, e), he.innerParams.set(
        this,
        e
      ), (s = this), (r = t), (c = e), new Promise(e => {
        const t = e => {
          s.closePopup({ isDismissed: !0, dismiss: e });
        };
        var n, o, i, a;
        ot.swalPromiseResolve.set(s, e), (r.confirmButton.onclick = () =>
          ((e, t) => {
            e.disableButtons(), t.input ? qt(e, t, "confirm") : Ut(e, t, !0);
          })(s, c)), (r.denyButton.onclick = () =>
          ((e, t) => {
            e.disableButtons(), t.returnInputValueOnDeny
              ? qt(e, t, "deny")
              : Vt(e, t, !1);
          })(s, c)), (r.cancelButton.onclick = () =>
          ((e, t) => {
            e.disableButtons(), t(l.cancel);
          })(s, t)), (r.closeButton.onclick = () =>
          t(l.close)), (n = s), (a = r), (e = t), he.innerParams.get(n).toast
          ? Jt(n, a, e)
          : (
              Xt(a),
              Gt(a),
              Qt(n, a, e)
            ), (o = s), (a = Me), (e = c), (i = t), a.keydownTarget &&
          ...
          ), (e = s), "select" === (a = c).input || "radio" === a.input
          ? Lt(e, a)
          : ["text", "email", "number", "tel", "textarea"].includes(a.input) &&
            (u(a.inputValue) || p(a.inputValue)) &&
            jt(e, a), At(c), en(Me, c, t), tn(r, c), setTimeout(() => {
    ...
    update: function(t) {
      ...
      }), (n = Object.assign({}, n, o)), Le(this, n), he.innerParams.set(
        this,
        n
  ...
  Object.assign(rn.prototype, e), Object.assign(rn, Je), Object.keys(
    e
  ).forEach(t => {
    rn[t] = function(...e) {
      if (sn) return sn[t](...e);
    };
  }), (rn.DismissReason = l), (rn.version = "11.0.11");
  const cn = rn;
