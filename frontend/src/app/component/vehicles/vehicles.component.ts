...
/**
 * Represents the VehiclesComponent class.
 * This component is responsible for managing the display and functionality of vehicles.
 */
export class VehiclesComponent {
  ...
  getVehicles(): void {
    this.vehiclesService
      .getAllVehiclesPages(this.currentPage, this.size)
      .subscribe(
        (data) => {
